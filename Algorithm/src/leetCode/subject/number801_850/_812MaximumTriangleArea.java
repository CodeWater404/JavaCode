package leetCode.subject.number801_850;

/**
 * @author ： CodeWater
 * @create ：2022-05-15-10:46
 * @Function Description ：最大三角形面积
 */
public class _812MaximumTriangleArea {
    class Solution {
...
// 枚举连续的三个点
        ...
        public double triangleArea( int x1 , int y1 , int x2 , int y2 , int x3 , int y3){
            return  0.5 * Math.abs( x1 * y2 + x2 * y3 + x3 * y1 - y2 * x3 - x1 * y3 - x2 * y1 );
        }
    }
}
