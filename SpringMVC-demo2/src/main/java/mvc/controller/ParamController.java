...
//requestParam映射请求参数名字和方法里面的参数对应关系，user_name请求的;required默认true，不传就报错，false时请求参数可以为空
//defaultValue：不管required属性值为true或false，当value所指定的请求参数没有传输或传输的值为""时，则使用默认值为形参赋值
    public String testParam(@RequestParam(value = "user_name", required = false, defaultValue = "hehe") String username,
                            String password,
                            String hobby,
                            @RequestHeader(value = "haha host", required = true, defaultValue = "hostDefault") String host,
